...
// 🟢 Get all orders (Admins can view all, Sellers only see their own)
...
// 🔵 Get a single order (Admins can view any, Sellers can only view their own)
...
exports.createOrder = async (req, res) => {
    try {
        ...
        const { items, totalPrice, stripePaymentIntentId } = req.body;
